...
Este código en Java utiliza Swing para crear una aplicación gráfica que muestra datos de una base de datos PostgreSQL sobre los constructores de Fórmula 1 y sus puntos en distintos años. La clase principal, Main, establece la conexión a la base de datos y construye la interfaz gráfica con un combo box para seleccionar el año, una tabla para mostrar los datos y una barra de progreso. Cuando se selecciona un año, un SwingWorker realiza una consulta SQL en segundo plano para obtener los datos de los constructores y sus puntos, asegurando que la interfaz siga siendo receptiva. Los resultados se actualizan en la tabla utilizando SwingUtilities.invokeLater, y la barra de progreso proporciona retroalimentación visual durante la carga de datos.
...
```
<img src="https://github.com/user-attachments/assets/2f50130b-5818-4557-ad15-ff674736c988" alt="image1" width="800"/>

<img src="https://github.com/user-attachments/assets/e18fb673-96c1-40c6-821c-058f77457a47" alt="image2" width="800"/>
